...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, n as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, o as lookupResultToBuffer, p as RequestStatusResponseStatus, U as UnknownError, q as RequestStatusDoneNoReplyErrorCode, s as RejectError, t as CertifiedRejectErrorCode, v as UNREACHABLE_ERROR, I as InputError, w as InvalidReadStateRequestErrorCode, x as ReadRequestType, y as Principal, z as IDL, A as MissingCanisterIdErrorCode, H as HttpAgent, D as encode, Q as QueryResponseStatus, F as UncertifiedRejectErrorCode, G as isV3ResponseBody, J as isV2ResponseBody, K as UncertifiedRejectUpdateErrorCode, N as UnexpectedErrorCode, O as decode, S as Subscribable, V as pendingThenable, X as resolveEnabled, Y as shallowEqualObjects, Z as resolveStaleTime, _ as noop$1, $ as environmentManager, a0 as isValidTimeout, a1 as timeUntilStale, a2 as timeoutManager, a3 as focusManager, a4 as fetchState, a5 as replaceData, a6 as notifyManager, a7 as hashKey, a8 as getDefaultState, r as reactExports, a9 as shouldThrowError, aa as useQueryClient, ab as useInternetIdentity, ac as createActorWithConfig, c as createLucideIcon, j as jsxRuntimeExports, B as Button, ad as Record, ae as Variant, af as Vec, ag as Service$1, ah as Func, ai as Opt, aj as Nat, ak as Text, al as Bool, am as Null, an as Int, ao as Principal$1 } from "./index-8CnPpmAi.js";
...
function ErrorMessage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": "error_state",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-full bg-destructive/10 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-8 w-8 text-destructive" }) }),
        ...
        onRetry && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", onClick: onRetry, className: "gap-2", children: [
...
const CreateServiceRequest = Record({
  "name": Text,
  "description": Text,
  "durationMinutes": Nat,
  "price": Text
...
const WeeklyAvailability = Vec(DayAvailability);
...
const UpdateServiceRequest = Record({
  "id": ServiceId,
  "name": Text,
  "description": Text,
  "durationMinutes": Nat,
...
Service$1({
  "cancelBooking": Func([BookingId], [Bool], []),
  "createBooking": Func([CreateBookingRequest], [BookingId], []),
  "createService": Func([CreateServiceRequest], [Service], []),
  "deleteService": Func([ServiceId], [Bool], []),
  "getAdmin": Func([], [Opt(Principal$1)], ["query"]),
  "getAvailability": Func([], [WeeklyAvailability], ["query"]),
  ...
  "listBookings": Func([], [Vec(Booking)], []),
  "listPastBookings": Func([], [Vec(Booking)], []),
  "listServices": Func([], [Vec(Service)], ["query"]),
  "listUpcomingBookings": Func([], [Vec(Booking)], []),
  "setAdmin": Func([], [], []),
  "setAvailability": Func([WeeklyAvailability], [], []),
  "updateBookingStatus": Func([BookingId, BookingStatus], [Bool], []),
  "updateService": Func([UpdateServiceRequest], [Bool], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const BookingId2 = IDL2.Nat;
  const DateStr2 = IDL2.Text;
  const ServiceId2 = IDL2.Nat;
  const TimeStr2 = IDL2.Text;
  ...
  const CreateServiceRequest2 = IDL2.Record({
    "name": IDL2.Text,
  ...
  const TimeRange2 = IDL2.Record({ "startTime": TimeStr2, "endTime": TimeStr2 });
  const DayAvailability2 = IDL2.Record({
    "day": DayOfWeek2,
    "ranges": IDL2.Vec(TimeRange2)
  });
  const WeeklyAvailability2 = IDL2.Vec(DayAvailability2);
  ...
  const UpdateServiceRequest2 = IDL2.Record({
    "id": ServiceId2,
    "name": IDL2.Text,
    "description": IDL2.Text,
    "durationMinutes": IDL2.Nat,
  ...
  return IDL2.Service({
    "cancelBooking": IDL2.Func([BookingId2], [IDL2.Bool], []),
    "createBooking": IDL2.Func([CreateBookingRequest2], [BookingId2], []),
    "createService": IDL2.Func([CreateServiceRequest2], [Service2], []),
    "deleteService": IDL2.Func([ServiceId2], [IDL2.Bool], []),
    "getAdmin": IDL2.Func([], [IDL2.Opt(IDL2.Principal)], ["query"]),
    "getAvailability": IDL2.Func([], [WeeklyAvailability2], ["query"]),
    ...
    "listBookings": IDL2.Func([], [IDL2.Vec(Booking2)], []),
    "listPastBookings": IDL2.Func([], [IDL2.Vec(Booking2)], []),
    "listServices": IDL2.Func([], [IDL2.Vec(Service2)], ["query"]),
    "listUpcomingBookings": IDL2.Func([], [IDL2.Vec(Booking2)], []),
    "setAdmin": IDL2.Func([], [], []),
    "setAvailability": IDL2.Func([WeeklyAvailability2], [], []),
    "updateBookingStatus": IDL2.Func(
      [BookingId2, BookingStatus2],
      [IDL2.Bool],
      []
    ),
    "updateService": IDL2.Func([UpdateServiceRequest2], [IDL2.Bool], [])
  });
};
class Backend {
...
function from_candid_DayAvailability_n4(_uploadFile, _downloadFile, value) {
  return from_candid_record_n5(_uploadFile, _downloadFile, value);
}
function from_candid_DayOfWeek_n6(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n7(_uploadFile, _downloadFile, value);
}
function from_candid_WeeklyAvailability_n2(_uploadFile, _downloadFile, value) {
...
function to_candid_BookingStatus_n21(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n22(_uploadFile, _downloadFile, value);
}
function to_candid_DayAvailability_n17(_uploadFile, _downloadFile, value) {
  return to_candid_record_n18(_uploadFile, _downloadFile, value);
}
function to_candid_DayOfWeek_n19(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n20(_uploadFile, _downloadFile, value);
}
function to_candid_WeeklyAvailability_n15(_uploadFile, _downloadFile, value) {
...
function useGetService(id2) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["service", id2 == null ? void 0 : id2.toString()],
    queryFn: async () => {
      if (!actor || id2 === void 0) return null;
      const result = await actor.getService(id2);
...
function useDeleteService() {
  ...
  return useMutation({
    mutationFn: async (id2) => {
      if (!actor) throw new Error("Not connected");
      return actor.deleteService(id2);
    },
    onSuccess: () => qc.invalidateQueries({ queryKey: ["services"] })
  });
}
function useGetAvailability() {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
...
function useSetAvailability() {
  const { actor } = useActor(createActor);
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async (availability) => {
      if (!actor) throw new Error("Not connected");
      return actor.setAvailability(availability);
    },
    onSuccess: () => qc.invalidateQueries({ queryKey: ["availability"] })
  });
}
function useGetTimeSlotsForDate(serviceId, date) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["timeslots", serviceId == null ? void 0 : serviceId.toString(), date],
    queryFn: async () => {
...
function useGetBooking(id2) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["booking", id2 == null ? void 0 : id2.toString()],
    queryFn: async () => {
      if (!actor || id2 === void 0) return null;
      const result = await actor.getBooking(id2);
      if (result && "__kind__" in result && result.__kind__ === "None")
        return null;
      if (result && "__kind__" in result && result.__kind__ === "Some")
        return result.value;
...
function useCancelBooking() {
  ...
  return useMutation({
    mutationFn: async (id2) => {
      if (!actor) throw new Error("Not connected");
      return actor.cancelBooking(id2);
    },
    onSuccess: () => qc.invalidateQueries({ queryKey: ["bookings"] })
  });
}
...
export {
  ErrorMessage as E,
  useGetService as a,
  useGetTimeSlotsForDate as b,
  useCreateBooking as c,
  useGetBooking as d,
  useGetAdmin as e,
  useSetAdmin as f,
  useCreateService as g,
  useUpdateService as h,
  useDeleteService as i,
  useGetAvailability as j,
  useSetAvailability as k,
  useListBookings as l,
  motion as m,
  useCancelBooking as n,
  useListServices as u
};
